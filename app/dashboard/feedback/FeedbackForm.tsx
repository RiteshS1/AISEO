        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              value={userEmail}
              disabled
              className="w-full bg-white/5 border border-white/10 px-6 py-4 text-slate-500 cursor-not-allowed focus:outline-none text-[11px] font-bold uppercase tracking-widest rounded-[7px]"
            />
          </div>
          <div>
            <label className="block text-slate-400 text-[10px] font-bold uppercase tracking-widest mb-2">
          ...
          <button
            ...
            className="w-full py-5 bg-lime-400 text-black font-black uppercase text-[11px] tracking-[0.3em] rounded-[7px] hover:bg-white transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
