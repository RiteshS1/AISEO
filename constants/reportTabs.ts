export type ReportPageId = 'COVER' | 'SUMMARY' | 'ANALYTICS' | 'DIAGNOSTIC' | 'SOCIAL' | 'PILLARS' | 'ROADMAP';

export const REPORT_NAV_ITEMS: ReadonlyArray<{ id: ReportPageId; label: string; icon: string }> = [
